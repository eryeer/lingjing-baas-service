...
import com.onchain.dna2explorer.exception.ParameterException;
import com.onchain.dna2explorer.exception.SqlGetValueException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseFormat<?> notFoundTokenException(NotFoundTokenException e){
        return new ResponseFormat<>(ReturnCode.NOT_FOUND_TOKEN, e.getMessage());
    }
