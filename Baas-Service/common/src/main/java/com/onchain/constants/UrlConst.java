...
public class UrlConst {
    ...
    public static final String SUBMIT_USER_KYC_UPDATE = "/baas/user/submitUserKycUpdate";
    public static final String GET_KYC_UPDATE_BY_ID = "/baas/user/getKycUpdateById";
    public static final String MARK_KYC_NOTIFY = "/baas/user/markKycNotify";
    public static final String GET_KYC_UPDATE_LIST = "/baas/user/getKycUpdateList";
    ...
    public static final String[] NOT_LOGIN_URLS = {REGISTER_USER, CHECK_USER_REGISTER, LOGIN, REFRESH_TOKEN, SEND_VERIFY_CODE, GET_SERVER_TIME, GET_RETURN_CODES, UPLOAD_FILE, RESET_PASSWORD,
            ...
            GET_TRANSFER_LIST_BY_ADDRESS, GET_TRANSFER_LIST_BY_ADDRESS_AND_TIME, GET_TRANSACTION_LIST_BY_ADDRESS_AND_TIME, GET_TOTAL_SUMMARY, GET_ADDRESS_SUMMARY, GET_BLOCK_SUMMARY, GET_TRANSACTION_SUMMARY, UPLOAD_ABI, GET_TOKEN_HOLDER, GET_CONTRACT_BY_CREATOR_ADDRESS
    };
    // 所有角色都可以访问的接口
    public static final String[] COMMON_URLS = {LOGOUT, GET_USER_BY_ID, GET_KYC_UPDATE_BY_ID, CHANGE_PASSWORD, CHANGE_PHONE_NUMBER, GET_PLATFORM_INFO, UPDATE_FILE, GET_TOOLS,
            ...
            GET_CHAIN_ACCOUNT, GET_GAS_CLAIM_HISTORY, GET_CHAIN_ACCOUNT_LIST_FOR_GAS_MANAGEMENT, GET_CONTRACT_BY_CHAIN_ACCOUNT_ADDRESS};
    // 普通用户 可以访问的接口
    public static final String[] CU_URLS = {APP_CREATE, APP_REMOVE, GET_APP_LIST, GET_APP, GET_CONTRACT_TEMPLATES, DEPLOY, UPDATE_FILE_LIST,
            ...
            SEND_CROSS_CHAIN, GET_CROSS_CHAIN, GET_CROSS_CHAIN_LIST, SET_CROSS_DST, GET_CROSS_TBD_LIST, SUBMIT_USER_KYC, SUBMIT_USER_KYC_UPDATE, MARK_KYC_NOTIFY,
            CREATE_GAS_CONTRACT, GET_GAS_CONTRACT_LIST, GET_GAS_SUMMARY, ACQUIRE_GAS, GET_DASHBOARD_SUMMARY};
    // PM 可以访问的接口
    public static final String[] PM_URLS = {APPROVE_USER_KYC, GET_USER_LIST, GET_USER_KYC_RECORD_LIST, GET_KYC_UPDATE_LIST,
            GET_ADMIN_GAS_CONTRACT_LIST, APPROVE_GAS_CONTRACT, GET_GAS_CONTACT_STATISTIC_LIST, GET_GAS_CLAIM_SUMMARY};
