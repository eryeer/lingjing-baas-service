...
public class UrlConst {
    ...
    public static final String[] CU_URLS = {APP_CREATE, APP_REMOVE, GET_APP_LIST, GET_APP, GET_CONTRACT_TEMPLATES, DEPLOY, UPDATE_FILE_LIST,
            ...
            CREATE_GAS_CONTRACT, GET_GAS_CONTRACT_LIST, GET_GAS_SUMMARY, GET_CHAIN_ACCOUNT_LIST_FOR_GAS_MANAGEMENT, ACQUIRE_GAS};
    // SM 可以访问的接口
    public static final String[] PM_URLS = {APPROVE_USER_KYC, GET_USER_LIST, GET_USER_KYC_RECORD_LIST,
            GET_ADMIN_GAS_CONTRACT_LIST, APPROVE_GAS_CONTRACT, GET_GAS_CONTACT_STATISTIC_LIST, GET_GAS_CLAIM_HISTORY, GET_GAS_CLAIM_SUMMARY};
