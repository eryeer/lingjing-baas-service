DROP DATABASE IF EXISTS dna2_baas;
CREATE DATABASE dna2_baas
...
CREATE TABLE `tbl_user` (
    ...
    `uni_social_credit_code` varchar(18) NOT NULL COMMENT '统一社会信用代码（必须为18位的字母数字组合）',
    `legal_person_name` varchar(10) NOT NULL COMMENT '法人姓名',
    `legal_person_idn` varchar(18) NOT NULL COMMENT '法人身份证号码',
    `apply_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '申请时间',
    `approve_status` varchar(10) NOT NULL DEFAULT 'Pending' COMMENT '审批状态（Pending：待认证 Approved：已认证 Rejected：已拒绝）',
    ...
    `legal_person_idb_file_uuid` varchar(32) NOT NULL COMMENT '法人身份证反面',
